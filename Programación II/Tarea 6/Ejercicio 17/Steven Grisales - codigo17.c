...
int main(){
	int es1 = 0; //Esta variable son los espacios que hay entre el inicio y la primera letra en cada f 
	int es2 = 17; //Esta variable son los espacios entre las letras de cada f 
