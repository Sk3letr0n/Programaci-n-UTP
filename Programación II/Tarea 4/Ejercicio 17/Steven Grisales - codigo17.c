...
int main(){
	int es1 = 0; //Esta variable son los espacios que hay entre el inicio y la primera letra en cada fila
	int es2 = 17; //Esta variable son los espacios entre las letras de cada fila

	//La variable f nos sirve para saber en que fila vamos
	for(int f = 1; f <= 9; f =  f + 1){
